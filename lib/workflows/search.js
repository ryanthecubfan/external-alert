...
var timer = process.env.SEARCH_TIMER || 60000;
var url = process.env.SEARCH_URL || "http://www.gettyimages.com/embeds?phrase=rainier&clarifications=&family=creative&excludenudity=false";
        ...
        action: function() {
            ...
            HttpLoader.execute(url)
                ...
                .catch(function(message) {
                    ...
                    console.log(message);
                    AlertManager.sendMail("Embed-Search Failure", "Embed-CDN failed: \r\n\r\nReason:\r\n\r\n" + message, mailRecipients);
                });
        }, 
        interval: timer
    };
