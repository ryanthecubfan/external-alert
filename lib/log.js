...
exports.write = function(component, msg, level) {
	...
	if ((level === "ERROR" || level === "SUCCESS") && this.config) {
		try {
			var url = this.config.url ? this.config.url : "https://sqs.us-west-2.amazonaws.com/961961469659/embed-monitor-events";
...
exports.init = function(config) {
	this.config = config;
	console.log("WORKER", "Setting AWS region to " + config.region);
